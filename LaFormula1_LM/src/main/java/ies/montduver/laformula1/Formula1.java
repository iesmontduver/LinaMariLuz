...
public class Formula1 {
    ...
    private static void crearEscuderies(List<Cotxe> cotxes, List<Box> pitLane) {
        ...
        Cotxe c4 = new Cotxe(McLaren, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(McLaren.getNom(),"F1", "Blanco", 500.0, 4.0,2.0 ));
        cotxes.add(c4);
        Cotxe c81 = new Cotxe(McLaren, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(McLaren.getNom(), "F1", "Blanco",500.0, 4.0,2.0 ));
        cotxes.add(c81);
        Cotxe c16 = new Cotxe(Ferrari, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(Ferrari.getNom(), "F1", "Roig",500.0, 4.0,2.0 ));
        cotxes.add(c16);
        Cotxe c55 = new Cotxe(Ferrari, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(Ferrari.getNom(), "F1", "Roig",500.0, 4.0,2.0 ));
        cotxes.add(c55);
        Cotxe c44 = new Cotxe(Mercedes, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(Mercedes.getNom(), "F1", "Verd",500.0, 4.0,2.0 ));
        cotxes.add(c44);
        Cotxe c63 = new Cotxe(Mercedes, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(Mercedes.getNom(), "F1", "Verd",500.0, 4.0,2.0 ));
        cotxes.add(c63);
        Cotxe c1 = new Cotxe(RedBull, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(RedBull.getNom(), "F1", "Blau",500.0, 4.0,2.0 ));
        cotxes.add(c1);
        Cotxe c11 = new Cotxe(RedBull, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(RedBull.getNom(), "F1", "Blau",500.0, 4.0,2.0 ));
        cotxes.add(c11);
        Cotxe c3 = new Cotxe(Toyota, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(McLaren.getNom(), "F1", "Gris",500.0, 4.0,2.0 ));
        cotxes.add(c3);
        Cotxe c42 = new Cotxe(Toyota, new Rodes("Michelín"), new Motor("diesel", 300.50, 15000), new Xasis(McLaren.getNom(), "F1", "Gris",500.0, 4.0,2.0 ));
        cotxes.add(c42);
